...
///
/// @deprecated **PDLS_EXT3_Basic_Wide** is deprecated and replaced by PDLS_Basic` with with drivers `Pervasive_Wide_Small` or `Pervasive_Wide_Medium`.
///
