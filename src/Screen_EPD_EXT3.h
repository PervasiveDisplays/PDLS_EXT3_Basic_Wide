...
///
#define SCREEN_EPD_EXT3_VARIANT "Basic-Wide"
...
class Screen_EPD_EXT3_Fast final : public hV_Screen_Buffer, public hV_Utilities_PDLS
{
  ...
  protected:
    ...
    void COG_MediumK_initial(uint8_t updateMode);
    void COG_MediumK_sendImageData(uint8_t updateMode);
    void COG_MediumK_update(uint8_t updateMode);
    void COG_MediumK_powerOff();

    void COG_SmallK_reset();
    void COG_SmallK_getDataOTP();
    void COG_SmallK_initial(uint8_t updateMode);
    void COG_SmallK_sendImageData(uint8_t updateMode);
    void COG_SmallK_update(uint8_t updateMode);
    void COG_SmallK_powerOff();
